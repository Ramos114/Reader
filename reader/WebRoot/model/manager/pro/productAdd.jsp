...
<div class="bg-light lter b-b wrapper-md">
	<h1 class="m-n font-thin h3">商品添加</h1>
</div>
<div class="wrapper-md">
	<div class="panel panel-default">
		<div class="panel-heading">添加商品列表</div>
									...
									<div class="form-horizontal ng-pristine ng-valid ng-valid-date ng-valid-required ng-valid-parse ng-valid-date-disabled">
										<div class="form-group">
											...
											<div class="col-sm-4">
												...
												<input type="text" id="proName" name="product.proName" class="form-control" placeholder="6-16位，由字母、数字、字符组成"> 
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" id="proNo" name="product.proNo" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
 ...
 -->
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" id="title" name="product.title" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="price" name="product.purchasePrice" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="price" name="product.price" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="discountPrice" name="product.discountPrice" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" id="store" name="product.store" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
...
<!-- 										
										...
										<div class="form-group">
											...
											<div class="col-sm-4">							
    											<input type="text" id="listingTime" name="product.listingTime" readonly="readonly" value="" class="form-control datetimepicker" placeholder="选择日期">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
    											<input type="text" id="delistingTime" name="product.delistingTime" readonly="readonly" value="" class="form-control datetimepicker" placeholder="选择日期">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" id="keywords" name="product.keywords" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" id="origin" name="product.origin" name="product.origin" class="form-control" placeholder="6-16位，由字母、数字、字符组成">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<textarea rows="4" id="introduce" name="product.introduce" class="form-control" placeholder="6-16位，由字母、数字、字符组成"></textarea>
										...
										<div class="form-group">
            								<label class="col-sm-2 control-label">主图上传(一张)</label>
            								<div class="col-sm-8">
                								<input id="file-MainPic" name="file" type="file" multiple>       
            								</div>
          								</div>  
										<div class="form-group">
            								<label class="col-sm-2 control-label">非主图上传(可批量)</label>
            								<div class="col-sm-8">
