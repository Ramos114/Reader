        ...
        <form class="navbar-form navbar-form-sm navbar-left shift" ui-shift="prependTo" data-target=".navbar-collapse" role="search" ng-controller="TypeaheadDemoCtrl">
          <div class="form-group">
            <div class="input-group">
              <input type="text" ng-model="selected" typeahead="state for state in states | filter:$viewValue | limitTo:8" class="form-control input-sm bg-light no-border rounded padder" placeholder="搜索菜单">
                ...
                <div class="list-group">
                  <a href class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="${basePath }${pageContext.request.contextPath}/source/Angular/img/a0.jpg" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="${basePath }${pageContext.request.contextPath}/source/Angular/img/a0.jpg" alt="...">
                <i class="on md b-white bottom"></i>
              </span>
              <span class="hidden-sm hidden-md">欢迎:${LOGINUSER.userName}</span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li class="divider"></li>
              <li>
                <a href="${basePath }${pageContext.request.contextPath}/LoginAction!logOut.action">注销</a>
              </li>
            </ul>
            <!-- / dropdown -->
          </li>
